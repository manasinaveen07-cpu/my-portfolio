...
const projects = [
  {
    ...
    description:
      'AI-powered Bharatanatyam mudra recognition system designed to identify hand gestures through a live webcam and provide meaningful learning feedback.',
  ...
  },
  {
    ...
    type: 'AI / Full Stack',
    description:
      'AI-assisted application for analyzing blood report data and presenting results through a user-friendly interface.',
      ...
      <main>
        ...
        <section id="home" className="hero section">
          <div className="hero-copy">
            ...
            <h2>
              Building practical web & AI solutions.
            </h2>

            <p className="hero-text">
              I’m an Information Science and Engineering student interested
              in full-stack development, artificial intelligence, computer
              vision and building useful products with clean, intuitive
              interfaces.
            </p>
        ...
        <section id="about" className="section">
          ...
          <div className="about-grid">
            <div className="info-card">
              <h3>Who I Am</h3>
              <p>
                I am a B.E. Information Science and Engineering student at
            ...
            <div className="info-card">
              <h3>What I Do</h3>
              <p>
                I enjoy building practical applications using web
                technologies and artificial intelligence, with a focus on
                clean interfaces and real-world problem solving.
              </p>
            </div>
            ...
            <div className="info-card">
              ...
              <p>
                My current interests include React, backend development,
                computer vision, machine learning and full-stack application
                development.
              </p>
            </div>
            ...
            <div className="info-card">
              <h3>My Goal</h3>
              <p>
                To continuously improve my technical skills by building
                useful projects and gaining practical industry experience.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="contact" className="contact section">
          ...
          <div className="contact-card">
            ...
            <div className="contact-row">
              <span>EMAIL</span>
              <a href="mailto:manasinaveen.07@gmail.com">
